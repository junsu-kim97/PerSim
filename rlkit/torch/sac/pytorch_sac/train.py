...
#        self.work_dir = os.path.join(self.work_dir, 'data', f"{env_name}", f'goal_idx{goal_idx}')
        self.work_dir = os.path.join(self.work_dir, "data", "point-robot-wind-v2", f"goal_idx{goal_idx}")
        ...
        while self.step < self.cfg.num_train_steps:
            if done:
                ...
                if self.step > self.cfg.num_seed_steps and self.step % self.cfg.eval_frequency == 0:
                    print(f"sampling on goal_idx {self.goal_idx} with step {self.step}")
