    ...
    def sample_tasks(self, n_tasks):
        ...
        if self.randomize_tasks:
            ...
            for i in range(n_tasks):
                ...
                # task_params = read_log_params(f"/home/changyeon/CaDM_MerPO/data/hopper-rand-params/goal_idx{i}/log.txt")
                # task_params = read_log_params_new(f"/home/changyeon/CaDM_MerPO/data/hopper-rand-params/goal_idx{i}/log.txt")
                task_params = read_log_params_new(f"/home/changyeon/hopper-rand-params/goal_idx{i}/log.txt")
...
@register_env("sparse-hopper-rand-params")
class SparseHopperRandParamsWrappedEnv(HopperRandParamsWrappedEnv):
    def __init__(self, n_tasks=2, randomize_tasks=True, max_episode_steps=1000, goal_radius=0.5):
        super(SparseHopperRandParamsWrappedEnv, self).__init__(n_tasks, randomize_tasks, max_episode_steps)
