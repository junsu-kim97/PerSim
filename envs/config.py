...
def get_environment_config(env):
    ...
    elif config['env'] in ['walker-rand-params', 'half-cheetah-rand-params',
                           'hopper-rand-params', 'slim-humanoid-rand-params']:
    ...
    # elif config['env'] == 'half-cheetah-rand-params':
    #     train_mass_scale_set = [None, None] # test 0.2, ,1.0, 1.8
    #     train_damping_scale_set = [None, None] # test 0.2, ,1.0, 1.8
    #     config['covariates'] = [None, None]
    #     config['env_default'] = [None, None]
    ...
    #     config['number_of_test_adapt_idxs'] = 40
    #     config['number_of_test_pred_idxs'] = 10
    #     config['env'] = ENVS['cheetah-rand-params']
    #     config['no_trajectories'] = None
    else:
        raise ValueError('Choose from available envs {"slimHumanoid", "ant", "halfCheetah", "mountainCar", "cartPole", "walker-rand-params", "half-cheetah-rand-params"}, refer to envs/config.py')
